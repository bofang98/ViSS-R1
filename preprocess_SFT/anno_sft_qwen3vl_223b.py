...
def init_model():
    MODEL_PATH = "/gpubox11/disk2/wuwenhao/backup/ckpt/Qwen3-VL-235B-A22B-Instruct"
...
# source /root/paddlejob/workspace/env_run/ENV/env_vision_llava.sh
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python anno_sft_qwen3vl_223b.py --split 0 --transformation 
