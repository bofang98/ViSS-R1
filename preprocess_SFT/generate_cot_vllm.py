...
def main():
    ...
    MODEL_PATH = "/gpubox11/disk2/wuwenhao/backup/ckpt/Qwen2.5-VL-72B-Instruct/"
    BSZ = 32
    ...
    for dataset_name in ['Video-R1-COT-165k']:
                ...
                "content": [
                    {
                        ...
                        x['data_type']: "/gpubox03/ssd3/fangbo05/Video-R1-data" + x['path'][1:]
                    },
                    {
                        "type": "text",
...
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python generate_cot_vllm.py