...
parser.add_argument("--model_path", required=True, help="Path or HF id for the model")
parser.add_argument("--video_path", required=True, help="Path to the input video")
parser.add_argument("--question", required=True, help="Question for the input video")
parser.add_argument(
    "--problem_type",
    default="free-form",
    choices=["multiple choice", "numerical", "OCR", "free-form", "regression"],
)
