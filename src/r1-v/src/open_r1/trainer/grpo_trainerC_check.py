...
class Qwen2VLGRPOTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        self.iteration += 1
        # with open('/ssd2/vis/wuwenhao/fangbo/Video-R1-main/used_training_data.txt', 'a') as f:  # 'a' 
        #     f.write(f"rank: {rank}, problem_id: {inputs[0]['problem_id']}\n")     
        ...
        sample_video, sample_rewards = self.video_mask_loss_dist(rank, inputs, video_inputs)
        

        prompt_inputs = self.processing_class(
            text=copy.deepcopy(prompts_text),
            images=image_inputs,
            videos=[sample_video[0]],
            return_tensors="pt",
            padding=True,
            padding_side="left",
        ...
        if self.temporal and video_inputs:
            # indices = torch.randperm(sample_video[0].size(0))
            # shuffled_video_inputs = [sample_video[0][indices]]
    ...
    def video_mask_loss_dist(self, rank, info, video_inputs):
        ...
        return [video_pos, video_neg], [max_avg_reward-min_avg_reward, torch.tensor(0.0)]
