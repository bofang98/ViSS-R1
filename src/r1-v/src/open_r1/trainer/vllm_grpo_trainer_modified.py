...
class Qwen2VLGRPOVLLMTrainerModified(Trainer):
    ...
    def compute_loss(
        ...
        if data_type == 'image':
            ...
            input_copy[0]['content'][0]['image'] = "/root/paddlejob/workspace/env_run/gpubox03_ssd3/fangbo05/Video-R1-data" + inputs[0]['path'][1:] 
        elif data_type == 'video':
            # input_copy[0]['content'][0]['video'] = os.getcwd() + "/Video-R1-data" + inputs[0]['path'][1:] 
            input_copy[0]['content'][0]['video'] = "/root/paddlejob/workspace/env_run/gpubox03_ssd3/fangbo05/Video-R1-data" + inputs[0]['path'][1:] 
