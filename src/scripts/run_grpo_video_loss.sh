...
DATASET_PATH="${DATASET_PATH:-/path/to/Video-R1-Video-260k-filter.json}"
OUTPUT_DIR="${OUTPUT_DIR:-./log/Pretext-500-High-Low-Uniform}"
RUN_NAME="${RUN_NAME:-High-Low-Quantity-Fix-Reward}"
